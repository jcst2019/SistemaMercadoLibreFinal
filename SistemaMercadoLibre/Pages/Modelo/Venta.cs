namespace SistemaMercadoLibre.Pages.Modelo
{
    public class Venta
    {
        ...
        public Venta(string idVenta, string nroOrden, string nombreProducto, string nombreProveedor, int cantidad, DateTime fechaRegistro, double precio, double importe, double igv, double subtotal, int estado)
        {
